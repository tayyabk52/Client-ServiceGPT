  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex h-full flex-col bg-black/40 backdrop-blur-xl border-r border-white/10">
          {/* Logo */}
      ...
      <div className="lg:ml-64">
        {/* Top Navigation */}
  <header className="bg-black/40 backdrop-blur-xl border-b border-white/10 px-4 lg:px-6 py-4 relative z-[200] pointer-events-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative z-[210] pointer-events-auto">
                ...
                {isNotificationsOpen && (
                  <div className="absolute right-0 mt-2 w-80 bg-black/95 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl z-[230]" onClick={(e)=>e.stopPropagation()}>
              ...
              <div className="relative z-[210] pointer-events-auto">
                ...
                {/* Profile Dropdown */}
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-48 bg-black/95 backdrop-blur-xl border border-white/20 rounded-xl shadow-2xl z-[230]" onClick={(e)=>e.stopPropagation()}>
                    <div className="p-2" onClick={(e) => e.stopPropagation()}>
                      <button className="w-full text-left px-3 py-2 text-white hover:bg-white/10 rounded-lg text-sm">
                        Profile Settings
                      </button>
                      <button className="w-full text-left px-3 py-2 text-white hover:bg-white/10 rounded-lg text-sm">
                        Account Security
                      ...
                      <button
                        ...
                        className="w-full flex items-center space-x-2 px-3 py-2 text-red-400 hover:bg-red-500/10 rounded-lg text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                      >
